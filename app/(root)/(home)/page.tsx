...
export default function Home() {
  ...
  return (
    <main className="min-h-screen ">
      {/* Hero Section */}
      <div className={`flex justify-between items-center gap-4 py-24 pl-28 overflow-hidden bg-[url('https://marcello.qodeinteractive.com/wp-content/uploads/2022/04/home-noise-.png')]`}>
        <div>
          <span className={`${fraunces.className} text-[34px] text-[#F43B00] italic mb-4`}>Family Pizzeria</span>
          <h1 className={`${staatliches.className} text-[110px] font-bold uppercase leading-[99px] text-[#F43B00]`}>
            WELCOME<br />
            TO ORIGINAL<br />
            ITALIAN<br />
            PIZZERIA</h1>
      ...
      {/* Work schedule */}
      <div className="py-[80px] flex items-stretch">
        <div className="">
          <Image src={pic1} alt="pic" style={{ width: '100%' }} />
        </div>
        <div className="bg-[url('https://marcello.qodeinteractive.com/wp-content/uploads/2022/04/home-noise-.png')] p-28 max-h-full flex flex-col justify-between">
          <div>
            <span className={`${fraunces.className} text-[34px] text-[#F43B00] italic mb-4`}>Working Hours</span>
            <h2 className={`${staatliches.className} text-[80px] font-bold uppercase leading-[70px] text-[#F43B00]`}>ENJOY AUTHENTIC ITALIAN TASTE</h2>
          </div>

          <div className="space-y-6">
            <div className="flex justify-between gap-4 items-end">
              <h5 className={`${staatliches.className} text-[34px] text-[#F43B00] p-0 m-0 leading-6`}>MONDAY - FRIDAY</h5>
              <div className="grow border-b-2 border-b-[#F43B00] border-dashed"></div>
              <span className={`${fraunces.className} text-[20px] text-[#F43B00] leading-4`}>9:00 - 22:00</span>
            </div>
            <div className="flex justify-between gap-4 items-end">
              <h5 className={`${staatliches.className} text-[34px] text-[#F43B00] p-0 m-0 leading-6`}>SATRUDAY</h5>
              <div className="grow border-b-2 border-b-[#F43B00] border-dashed"></div>
              <span className={`${fraunces.className} text-[20px] text-[#F43B00] leading-4`}>10:00 - 20:00</span>
            </div>
            <div className="flex justify-between gap-4 items-end">
              <h5 className={`${staatliches.className} text-[34px] text-[#F43B00] p-0 m-0 leading-6`}>SUNDAY</h5>
              <div className="grow border-b-2 border-b-[#F43B00] border-dashed"></div>
              <span className={`${fraunces.className} text-[20px] text-[#F43B00] leading-4`}>closed</span>
            </div>
          </div>
      ...
      {/* Blog */}
      <div className="py-[80px] flex items-stretch justify-around">
      ...
      {/* Reservetion  */}
      <div className="py-[80px] px-[100px] bg-[url('https://marcello.qodeinteractive.com/wp-content/uploads/2022/04/home-noise-.png')]">
        <form action="" className="p-0 m-0 space-y-6">
          ...
          <div className="flex gap-4 justify-between items-center m-0">
            ...
            <span className={`${mooli.className} text-[#F43B00]`}>FOR</span>
            <div className="grow">
            ...
            <span className={`${mooli.className} text-[#F43B00]`}>AT</span>
            <div className="relative grow">
      ...
      <div className="flex items-stretch">
        <div className="bg-[#F43B00] grow text-white p-28 flex flex-col justify-between">
          <div>
            <span className={`${fraunces.className} text-[34px]  italic mb-4`}>From Our Menu</span>
            <h2 className={`${staatliches.className} text-[80px] font-bold uppercase leading-[70px]`}>POPULAR PICKS &<br /> NEW TASTES!</h2>
          </div>
          <div>
            <p>VOLUPTATEM EA RERUM NISI. ULLAM DEBITIS OPTIO. QUAE ODIO</p>
          </div>
        </div>
        <div className="grow p-28">
